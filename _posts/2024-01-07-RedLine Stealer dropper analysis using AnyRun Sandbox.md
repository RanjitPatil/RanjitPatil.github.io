---
title: "RedLine Stealer dropper analysis using AnyRun Sandbox"
classes: wide
tags: [RedLine Stealer]
header:
    teaser: /assets/images/redline.png
description: "RedLine Stealer, an infostealer malware first identified in March 2020, specializes in extracting valuable information and assets from compromised systems, primarily targeting end users. Commonly distributed through compromised software downloads, phishing attempts, and drive-by downloads, RedLine Stealer focuses on pilfering insecure passwords and cryptocurrency wallets."
...
> [https://app.any.run/tasks/5a51d459-6caa-47dd-9b27-715ca2ec92bb/](https://app.any.run/tasks/5a51d459-6caa-47dd-9b27-715ca2ec92bb/)             

> [https://app.any.run/tasks/6212356e-6b48-4e80-b0fc-8c3dd5111e1d/](https://app.any.run/tasks/6212356e-6b48-4e80-b0fc-8c3dd5111e1d/)

### MalwareBazaar

> [https://bazaar.abuse.ch/sample/3086ac8861aaccdf3dc45f3b1380b6cd70169c7d9fc16f098f5a1d08736fed61/](https://bazaar.abuse.ch/sample/3086ac8861aaccdf3dc45f3b1380b6cd70169c7d9fc16f098f5a1d08736fed61/)
...
-	In this script it uses simple subtraction before converting the character to Ascii using chr.
      ...
      **Reference Link -** [https://isvbscriptdead.com/vbs-obfuscator/](https://isvbscriptdead.com/vbs-obfuscator/)
...
- CyberChef Receipes : [https://github.com/Securityinbits/malware-analysis/blob/main/analysis/redline_stealer_aug_2023.md](https://github.com/Securityinbits/malware-analysis/blob/main/analysis/redline_stealer_aug_2023.md)
